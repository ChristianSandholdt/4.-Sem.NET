...
Medarbejder m1 = new Mekaniker(cpr1,"Mohammed Salah", a1,2005,285);
Medarbejder m2 = new Mekaniker(cpr2,"Alisson", a1, 2012, 290);
Medarbejder m3 = new Vaerkfoerer(cpr3,"Darwin", a1, 2011, 250, 2022, 3000);
Medarbejder m4 = new Vaerkfoerer(cpr4, "Trent", a1, 2010, 270, 2020, 6000);
Medarbejder m5 = new Synsmand(cpr5,"Jürgen", a1,2000, 400, 15);
...
var firmaMedarbejderCol = new Collection<object>();
firmaMedarbejderCol.addElement(f1.Adresse, f1);
firmaMedarbejderCol.addElement(f2.Adresse, f2);
firmaMedarbejderCol.addElement(m1.Cpr, m1);
firmaMedarbejderCol.addElement(m2.Cpr, m2);

Console.WriteLine(firmaMedarbejderCol.size());

firmaMedarbejderCol.Print();
